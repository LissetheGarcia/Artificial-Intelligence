...
# Dibujamos un retándulo basado en la seleción de entrada
def draw_rectangle(event, x, y, flags, params):
    global x_init, y_init, drawing, top_left_pt, bottom_right_pt, img_orig
    # Detectamos el evento del lickeo del ratón
    if event == cv2.EVENT_LBUTTONDOWN:
        drawing = True
        x_init, y_init = x, y
    # Detectamos el movimiento del mause
    ...
    # Detectamos el movimiento del ratón haia arriba
