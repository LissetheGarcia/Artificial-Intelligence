...
def build_arg_parser():
    ...
    parser.add_argument("--samples", dest="cls", nargs="+", action="append", required=True, help="Folders containing the training images. The first element needs to be the class label.")
...
class Quantizer(object):
    ...
    def quantize(self, datapoints):
        ...
        kmeans = KMeans(self.num_clusters, n_init=max(self.num_retries, 1),
        max_iter=10, tol=1.0)
