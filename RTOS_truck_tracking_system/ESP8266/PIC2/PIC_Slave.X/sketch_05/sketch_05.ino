...
setup()
    ...
    wifi:
        wifiMulti.addAP( "RED", "CONTRASEÑA" );   // add Wi-Fi 
...
handleRoot() 
    ...
    server.send
        ...
        "<body bgcolor=:FFC0CB>"
        "</body>"
        "<table width=550 bgcolor=FFFFFF align=center>"
        "<tr>"
      "<td>"
            "<h1> <center> Bienvenido a tu centro de control de flores de ornato  </center></h1>"
            ...
            "</form>"
            "<p><center>Try 'Lissethe Garcia' and 'pwd123' ...</center></p>"
        "</td>"
      "</tr>"
        "</table>"
        )
...
handleLogin() 
    ...
    if  ( 
           server.arg( "username" ) == "Lissethe Garcia" 
        ...
        server.send
           ...
           "<tr>"
           "<td>"
           "<h1><center>Welcome, " + server.arg("username") + "! </center></h1>"
           "<p><center>Login successful <a href=\"/user\">Go to ESP8266 "
           " I/O!!!</a> </center></p>"
           "</td>"
       "</tr>"
           )
        ...
        server.send(401, "<center>text/plain</center>", "<center>401: Unauthorized</center>");
        }
    }
...
handleUser() 
    ...
    sprintf
       ...
       "<tr>"
       "<td>"
       "<p><center>Water Reserve status  = %d </center></p>"
       "<p><center>Humidity = %d </center></p>"
       "<hr>"
       "<p><a href=\"/\"><center>Log out!</center></a></p>"
       "</td>"
       "</tr>",
       digitalRead( in_sw ),
       255 - humidity
